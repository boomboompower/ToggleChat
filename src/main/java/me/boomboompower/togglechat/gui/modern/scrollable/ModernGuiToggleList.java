...
public class ModernGuiToggleList extends GuiListExtended {
    ...
    public ModernGuiToggleList(IHaveScrollableData scrollableData) {
        super(Minecraft.getMinecraft(), scrollableData.width, scrollableData.height, 63, scrollableData.height - 32, 20);
    ...
    public void drawScreen(int mouseXIn, int mouseYIn, float partialTicks) {
        ...
        if (j1 > 0) {
            int k1 = MathHelper.clamp_int((this.bottom - this.top) * (this.bottom - this.top) / this.getContentHeight(), 32, this.bottom - this.top - 8);
            int scrollTop = (int) this.amountScrolled * (this.bottom - this.top - k1) / j1 + this.top;
            ...
            ModernGui.drawRect(i, scrollTop + k1 - 1, j, scrollTop, new Color(192, 192, 192).getRGB());
        }
