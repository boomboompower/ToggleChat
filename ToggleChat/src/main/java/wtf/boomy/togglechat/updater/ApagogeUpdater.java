package wtf.boomy.togglechat.updater;
...
public class ApagogeUpdater implements ApagogeVerifier {
    ...
    public void run() {
        ...
        try {
            int current = Integer.parseInt(IOUtils.toString(actionsBuild, StandardCharsets.UTF_8)) + 17;
            
            String version = "3.0." + current;
            
            Version buildVersion = new Version(version);
            
            String url = "https://api.github.com/repos/boomboompower/ToggleChat/releases";
